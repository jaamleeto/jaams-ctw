...
public class DBManager {
	...
	public DBManager(JaamsCtwMod plugin, DBType dbType, String database, String user, String password) throws ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException {
		this.plugin = plugin;
	...
	private void MySQLConnection(String database, String user, String password) throws ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException {
	...
	private void SQLiteConnection() throws ClassNotFoundException, SQLException {
		...
		connection = DriverManager.getConnection("jdbc:sqlite:" + plugin.getDataFolder().getAbsolutePath() + "/" + plugin.getName() + ".db");
	}
	...
	public boolean addEvent(String playerName, String relatedPlayerName, String description) {
		return executeUpdate("INSERT INTO events VALUES( null, '" + playerName + "', " + (relatedPlayerName == null ? "null," : "'" + relatedPlayerName + "', ") + "'" + description + "'" + ");");
	}
